"""Shared runner for curriculum exercises with standard recording flow."""
...
def run_generic_exercise(exercise_id, next_page):
    """Run a manifest-backed exercise through the shared three-stage flow."""
    init_session_state()
    inject_custom_css()
    ...
    if st.session_state.exercise_stage == "introduction":
        ...
        render_recording_stage(exercise_id)
