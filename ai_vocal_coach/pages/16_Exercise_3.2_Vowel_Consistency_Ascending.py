"""Exercise 3.2 — Vowel Consistency on Ascending Scale"""
...
from components.exercise_flow import (
    ...
    render_introduction_stage, render_recording_stage, render_results_stage,
)
from utils.state import init_session_state
from utils.pages_config import get_page_info

EXERCISE_ID = "16_Exercise_3.2_Vowel_Consistency_Ascending"
NEXT_PAGE = "pages/17_Exercise_3.3_Vowel_Modification_High_Notes.py"
